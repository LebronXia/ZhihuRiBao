...
import com.xiamu.riane.zhihuribao.fragment.NewsFragment;
...
public class NewsContentActivity extends BaseActivity implements RevealBackgroundView.OnStateChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entity = (StoriesEntity) getIntent().getSerializableExtra(NewsFragment.EXTRA_STORIES);
    ...
    private void init(){
        ...
        mToolbar.setTitle(entity.getTitle());
